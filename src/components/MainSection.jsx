  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="absolute top-16 left-0 right-0 px-2 sm:px-6 md:px-10 flex flex-col sm:flex-row items-center justify-between z-10 gap-3 sm:gap-4"
      >
        {/* Nav Buttons */}
        ...
        <motion.div variants={logoVariants} className="flex justify-center w-full sm:w-auto my-2 sm:my-0">
        ...
        <motion.div
          ...
          className="flex items-center space-x-2 sm:space-x-3 mt-2 sm:mt-0"
        >
      ...
      <motion.div
        ...
        className="absolute bottom-8 left-4 sm:left-8 right-4 max-w-xl space-y-4 px-2 sm:px-4 z-10"
      >
